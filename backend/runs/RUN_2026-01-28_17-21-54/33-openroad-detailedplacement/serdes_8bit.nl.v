module serdes_8bit (bus_free_flag,
 ...
 sky130_fd_sc_hd__and2_1 _415_ (.A(net31),
    .B(_207_),
    .X(_085_));
 sky130_fd_sc_hd__dfxtp_1 _416_ (.CLK(clk),
    .D(_015_),
    .Q(\deserializer_u1.par_out[9] ));
 sky130_fd_sc_hd__dfxtp_1 _417_ (.CLK(clk),
    .D(_016_),
    .Q(\deserializer_u2.temp_3b[0] ));
 sky130_fd_sc_hd__dfxtp_1 _418_ (.CLK(clk),
    .D(_017_),
    .Q(\deserializer_u2.temp_3b[1] ));
 sky130_fd_sc_hd__dfxtp_1 _419_ (.CLK(clk),
    .D(_018_),
    .Q(\deserializer_u2.temp_3b[2] ));
 sky130_fd_sc_hd__dfxtp_1 _420_ (.CLK(clk),
    .D(_019_),
    .Q(\deserializer_u1.shift_reg[0] ));
 sky130_fd_sc_hd__dfxtp_1 _421_ (.CLK(clk),
    .D(_020_),
    .Q(\deserializer_u1.shift_reg[1] ));
 sky130_fd_sc_hd__dfxtp_1 _422_ (.CLK(clk),
    .D(_021_),
    .Q(\deserializer_u1.shift_reg[2] ));
 sky130_fd_sc_hd__dfxtp_1 _423_ (.CLK(clk),
    .D(_022_),
    .Q(\deserializer_u1.shift_reg[3] ));
 sky130_fd_sc_hd__dfxtp_1 _424_ (.CLK(clk),
    .D(_023_),
    .Q(\deserializer_u1.shift_reg[4] ));
 sky130_fd_sc_hd__dfxtp_1 _425_ (.CLK(clk),
    .D(_024_),
    .Q(\deserializer_u1.shift_reg[5] ));
 sky130_fd_sc_hd__dfxtp_1 _426_ (.CLK(clk),
    .D(_025_),
    .Q(\deserializer_u1.shift_reg[6] ));
 sky130_fd_sc_hd__dfxtp_1 _427_ (.CLK(clk),
    .D(_026_),
    .Q(\deserializer_u1.shift_reg[7] ));
 sky130_fd_sc_hd__dfxtp_1 _428_ (.CLK(clk),
    .D(_027_),
    .Q(\deserializer_u1.shift_reg[8] ));
 sky130_fd_sc_hd__dfxtp_1 _429_ (.CLK(clk),
    .D(_028_),
    .Q(\deserializer_u1.shift_reg[9] ));
 sky130_fd_sc_hd__dfxtp_1 _430_ (.CLK(clk),
    .D(_029_),
    .Q(\deserializer_u2.temp_5b[0] ));
 sky130_fd_sc_hd__dfxtp_1 _431_ (.CLK(clk),
    .D(_030_),
    .Q(\deserializer_u2.temp_5b[1] ));
 sky130_fd_sc_hd__dfxtp_1 _432_ (.CLK(clk),
    .D(_031_),
    .Q(\deserializer_u2.temp_5b[2] ));
 sky130_fd_sc_hd__dfxtp_1 _433_ (.CLK(clk),
    .D(_032_),
    .Q(\deserializer_u2.temp_5b[3] ));
 sky130_fd_sc_hd__dfxtp_1 _434_ (.CLK(clk),
    .D(_033_),
    .Q(\deserializer_u2.temp_5b[4] ));
 sky130_fd_sc_hd__dfxtp_1 _435_ (.CLK(clk),
    .D(_003_),
    .Q(net11));
 sky130_fd_sc_hd__dfxtp_1 _436_ (.CLK(clk),
    .D(_000_),
    .Q(\controller_unit.q[1] ));
 sky130_fd_sc_hd__dfxtp_1 _437_ (.CLK(clk),
    .D(_004_),
    .Q(\controller_unit.load_en ));
 sky130_fd_sc_hd__dfxtp_1 _438_ (.CLK(clk),
    .D(_001_),
    .Q(\controller_unit.q[3] ));
 sky130_fd_sc_hd__dfxtp_1 _439_ (.CLK(clk),
    .D(_002_),
    .Q(\controller_unit.par_en ));
 sky130_fd_sc_hd__dfxtp_1 _440_ (.CLK(clk),
    .D(_005_),
    .Q(\controller_unit.q[5] ));
 sky130_fd_sc_hd__dfxtp_1 _441_ (.CLK(clk),
    .D(_034_),
    .Q(\serializer_u3.shift_reg[9] ));
 sky130_fd_sc_hd__dfxtp_1 _442_ (.CLK(clk),
    .D(_035_),
    .Q(\serializer_u3.shift_reg[0] ));
 sky130_fd_sc_hd__dfxtp_1 _443_ (.CLK(clk),
    .D(_036_),
    .Q(\serializer_u3.shift_reg[1] ));
 sky130_fd_sc_hd__dfxtp_1 _444_ (.CLK(clk),
    .D(_037_),
    .Q(\serializer_u3.shift_reg[2] ));
 sky130_fd_sc_hd__dfxtp_1 _445_ (.CLK(clk),
    .D(_038_),
    .Q(\serializer_u3.shift_reg[3] ));
 sky130_fd_sc_hd__dfxtp_1 _446_ (.CLK(clk),
    .D(_039_),
    .Q(\serializer_u3.shift_reg[4] ));
 sky130_fd_sc_hd__dfxtp_1 _447_ (.CLK(clk),
    .D(_040_),
    .Q(\serializer_u3.shift_reg[5] ));
 sky130_fd_sc_hd__dfxtp_1 _448_ (.CLK(clk),
    .D(_041_),
    .Q(\serializer_u3.shift_reg[6] ));
 sky130_fd_sc_hd__dfxtp_1 _449_ (.CLK(clk),
    .D(_042_),
    .Q(\serializer_u3.shift_reg[7] ));
 sky130_fd_sc_hd__dfxtp_1 _450_ (.CLK(clk),
    .D(_043_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _453_ (.CLK(clk),
    .D(_046_),
    .Q(\serializer_u2.temp_6b[2] ));
 sky130_fd_sc_hd__dfxtp_1 _454_ (.CLK(clk),
    .D(_047_),
    .Q(\serializer_u2.temp_6b[3] ));
 sky130_fd_sc_hd__dfxtp_1 _455_ (.CLK(clk),
    .D(_048_),
    .Q(\serializer_u2.temp_6b[4] ));
 sky130_fd_sc_hd__dfxtp_1 _456_ (.CLK(clk),
    .D(_049_),
    .Q(\serializer_u2.temp_6b[5] ));
 sky130_fd_sc_hd__dfxtp_1 _457_ (.CLK(clk),
    .D(_050_),
    .Q(\serializer_u2.temp_4b[0] ));
 sky130_fd_sc_hd__dfxtp_1 _458_ (.CLK(clk),
    .D(_051_),
    .Q(\serializer_u2.temp_4b[1] ));
 sky130_fd_sc_hd__dfxtp_1 _459_ (.CLK(clk),
    .D(_052_),
    .Q(\serializer_u2.temp_4b[2] ));
 sky130_fd_sc_hd__dfxtp_1 _460_ (.CLK(clk),
    .D(_053_),
 ...
 sky130_fd_sc_hd__dlxtn_1 _468_ (.D(_013_),
    .GATE_N(_014_),
    .Q(\data_8b_out[7] ));
 sky130_fd_sc_hd__dfxtp_1 _469_ (.CLK(clk),
    .D(_054_),
    .Q(net12));
 sky130_fd_sc_hd__dfxtp_1 _470_ (.CLK(clk),
    .D(_055_),
    .Q(net13));
 sky130_fd_sc_hd__dfxtp_1 _471_ (.CLK(clk),
    .D(_056_),
    .Q(net14));
 sky130_fd_sc_hd__dfxtp_1 _472_ (.CLK(clk),
    .D(_057_),
    .Q(net15));
 sky130_fd_sc_hd__dfxtp_1 _473_ (.CLK(clk),
    .D(_058_),
    .Q(net16));
 sky130_fd_sc_hd__dfxtp_1 _474_ (.CLK(clk),
    .D(_059_),
    .Q(net17));
 sky130_fd_sc_hd__dfxtp_1 _475_ (.CLK(clk),
    .D(_060_),
    .Q(net18));
 sky130_fd_sc_hd__dfxtp_1 _476_ (.CLK(clk),
    .D(_061_),
    .Q(net19));
 sky130_fd_sc_hd__dfxtp_1 _477_ (.CLK(clk),
    .D(_062_),
    .Q(\data_10b_out[0] ));
 sky130_fd_sc_hd__dfxtp_1 _478_ (.CLK(clk),
    .D(_063_),
    .Q(\data_10b_out[1] ));
 sky130_fd_sc_hd__dfxtp_1 _479_ (.CLK(clk),
    .D(_064_),
    .Q(\data_10b_out[2] ));
 sky130_fd_sc_hd__dfxtp_1 _480_ (.CLK(clk),
    .D(_065_),
    .Q(\data_10b_out[3] ));
 sky130_fd_sc_hd__dfxtp_1 _481_ (.CLK(clk),
    .D(_066_),
    .Q(\data_10b_out[4] ));
